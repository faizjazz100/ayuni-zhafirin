    ...
    return (
        <main className="min-h-screen text-zinc-800">
            ...
            <PageShell>
                ...
                {/* Venue Card */}
                <div className="mt-8 rounded-3xl border border-zinc-200 bg-white/65 p-6">
                ...
                {/* Helpful Notes */}
                <div className="mt-6 rounded-3xl border border-zinc-200 bg-white/65 p-6 text-sm text-zinc-700">
